...
parser.add_argument(
    "-m", "--modulus", metavar="MODULUS", dest="modulus", type=int, help="LCG modulus"
)
parser.add_argument(
    "-a",
    "--multiplier",
...
parser.add_argument(
    "-c", "--increment", metavar="INCREMENT", dest="inc", type=int, help="LCG increment"
)
parser.add_argument(
    "-n", "--next", metavar="COUNT", dest="next", type=int, help="Calculate next values"
)
